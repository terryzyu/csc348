...
#Runs code
java -cp build/classes:lib/java-cup-11b.jar MiniJava -A "SamplePrograms/SampleMiniJavaPrograms/BinarySearch-errors.java" > result.txt

echo 'Running diff binary result'

diff BinarySearch-errors-output.txt result.txt
#cat result.txt
echo 'Done!'
